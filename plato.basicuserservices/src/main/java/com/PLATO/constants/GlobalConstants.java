...
public class GlobalConstants
{
    ...
    public static final String AuthToken = PropertiesFileUtility.getProperty("AUTHENTICATION_KEY");
    public static final String SecretAuthKey="secret-this-is-jsut-for-development";
    ...
    public static final String CURL_HOME=PropertiesFileUtility.getProperty("CURL_HOME");
    public static final String TOMCAT_URL=PropertiesFileUtility.getProperty("TOMCAT_URL");
    public static final String TOMCAT_PORT=PropertiesFileUtility.getProperty("TOMCAT_PORT");
}
