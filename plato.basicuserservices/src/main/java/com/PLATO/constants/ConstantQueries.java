...
public class ConstantQueries
{
	...
	public static final String VALIDATEUSER="SELECT usrmst.name, upm.projectMaster.project_id, upm.projectMaster.project_name,upm.accountMaster.account_id, upm.accountMaster.account_name, upm.portfolioMaster.portfolio_id, upm.portfolioMaster.portfolio_name,upm.default_project  FROM UserMaster usrmst, UserProjectMapping upm where usrmst.user_id=:user_id AND usrmst.password=:password and usrmst.user_id=upm.userMaster.user_id";


	
	//query to get list of module names for project   
	public static final String GETMODULENAMELIST="SELECT mj.jenkins_job_id, mj.jenkins_job_name,mj.description FROM ModuleJobsJenkins mj where mj.projectMaster.project_name=:project_name";
	...
	public static final String GETCATEGORYWISETOOLS="SELECT cm.category_id, cm.category_name, ptm.toolMaster.tool_id, ptm.toolMaster.tool_name,ptm.command_to_execute,ptm.report_path,ptm.nodeMaster.node_id,ptm.nodeMaster.node_name FROM ToolMaster tm, ProjectToolMapping ptm, CategoryMaster cm WHERE ptm.projectMaster.project_id=:projectId AND tm.categoryMaster.category_id=cm.category_id AND tm.tool_id=ptm.toolMaster.tool_id";
	...
	public static final String GETMODULECONFIG="SELECT mj.jenkins_job_id, mj.jenkins_job_name, mj.module_subjobs_order,mj.description FROM ModuleJobsJenkins mj WHERE mj.jenkins_job_name=:moduleName";
	//query to get details of a sub module
	public static final String GETSUBMODULEDATA="SELECT msj.subjob_id, msj.subjob_name, msj.nodeMaster.node_id, msj.nodeMaster.node_name, msj.command_to_execute, msj.report_path, msj.subjob_description, msj.tool_name, msj.postbuild_subjob,msj.moduleJobsJenkins.jenkins_job_id,msj.is_ladyBug_checked,msj.is_alm_checked,msj.order_number,msj.postBuild_trigger_option FROM  ModuleSubJobsJenkins msj WHERE msj.moduleJobsJenkins.jenkins_job_name=:moduleName ORDER BY msj.subjob_id";
	...
	//get checkpoints for subjob from subjob_id
	public static final String GETCHECKPOINTFORSUBJOB="FROM SubjobCheckpoint sc WHERE sc.moduleSubJob.subjob_id=:subjob_id";

	//get checkpoints for subjob from subjob_id
	public static final String GETCHECKPOINTFORTOOL="FROM CheckpointTemplate ct WHERE ct.projectToolMapping.tool_project_mapping_id=:project_tool_mapping_id";

	//get checkpoints for subjob from subjob_id
	public static final String GETSTATUSBYNAME="FROM StatusMaster sm WHERE sm.status_name=:status_name";
	
	//update checkpoint order
	public static final String UPDATECHECKPOINTDETAILORDER="UPDATE CheckpointDetailsTemplate cdt SET cdt.order_number=cdt.order_number-1 WHERE cdt.order_number>:order_number AND cdt.checkpoint_template.checkpoint_template_id=:checkpoint_template_id";
	public static final String UPDATECHECKPOINTTEMPLATEORDER="UPDATE CheckpointTemplate ct SET ct.order_number=ct.order_number-1 WHERE ct.order_number>:order_number AND ct.projectToolMapping.tool_project_mapping_id=:project_tool_mapping_id";
	
	public static final String GET_PROJECT_TOOL_MAPPING="SELECT ptm.tool_project_mapping_id FROM ProjectToolMapping ptm WHERE ptm.toolMaster.tool_name=:tool_name AND ptm.projectMaster.project_id=:project_id";

	public static final String GET_LATEST_BUILD_HISTORY="SELECT MAX(mbh.build_number), mbh.statusMaster.status_name FROM ModuleBuildHistory mbh WHERE mbh.moduleJobsJenkins.jenkins_job_id=:moduleId";
	/**********************************************************************************/
	...
	public static String GET_ALLOCATED_PROJECTS="select distinct upm.projectMaster.project_id, upm.projectMaster.project_name FROM UserProjectMapping upm where upm.userMaster.user_id=:userId";
	public static String GET_USERS_MAPPING_WITH_PROJECT="select upm.id from UserProjectMapping upm where upm.userMaster.user_id=:userId and upm.projectMaster.project_id=:projectId";
	...
	public String getBUILD_WISE_STATUS_COUNT_FOR_SELECTED_PROJECTS() {
		return "SELECT tt.jenkins_job_id,tt.build_number,st.status_name "+
				...
				" ON tt.jenkins_job_id = groupedtt.jenkins_job_id"+ 
     			...
     			" on pm.project_id=upm.project_id and"+
     			" upm.user_id=:userId"+
     			" and pm.project_name in(:projNamesLIST)"+
     			" and pm.account_id in (select acc.account_id from account_master acc where acc.account_name=:accountName))";
	}
 ...
 " group by b.jenkins_job_id";*/
	...
	public static String GET_MODULE_FOR_USER_PROJECT="SELECT mj.jenkins_job_id,mj.jenkins_job_name,mj.module_creation_date,mj.description  FROM ModuleJobsJenkins mj WHERE mj.projectMaster.project_name=:project_name AND mj.projectMaster.project_name IN (SELECT upm.projectMaster.project_name FROM UserProjectMapping upm WHERE upm.userMaster.user_id=:user_id)";
	public static String GET_LAST_BUILD_DETAILS="SELECT mbh.module_build_history_id, mbh.build_number, mbh.timestamp, mbh.statusMaster.status_name FROM ModuleBuildHistory mbh WHERE mbh.moduleJobsJenkins.jenkins_job_id=:module_id AND mbh.build_number=(SELECT MAX(mb1.build_number) FROM ModuleBuildHistory mb1 WHERE mb1.moduleJobsJenkins.jenkins_job_id=:module_id)";
	
	public static String GET_MODULE_FOR_USER_ACCOUNT="SELECT mj.jenkins_job_id,mj.jenkins_job_name,mj.module_creation_date,mj.description  FROM ModuleJobsJenkins mj WHERE mj.projectMaster.project_id IN (SELECT upm.projectMaster.project_id FROM UserProjectMapping upm WHERE upm.userMaster.user_id=:user_id AND upm.projectMaster.project_id IN (SELECT pm.project_id FROM ProjectMaster pm WHERE pm.accountMaster.account_name=:account_name))";
 ...
 ")";
	...
	public static String GET_PARTICULAR_PORTFOLIO="from PortfolioMaster where portfolio_id=:portfolioId";   
	...
	public static String GET_ACCOUNTS_FOR_PORTFOLIO="select am.account_name,am.account_id FROM AccountMaster am , PortfolioMaster pm ,ProjectMaster pm2 where "+ 
			" am.portfolioMaster.portfolio_id=pm.portfolio_id"+" and am.account_id=pm2.accountMaster.account_id"+
			" and am.portfolioMaster.portfolio_id = (select mn.portfolio_id from PortfolioMaster mn where mn.portfolio_name=:portfolioName)"+
	...
	public static final String GET_JENKINS_SUB_JOBS =" from ModuleSubJobsJenkins msbj where msbj.moduleJobsJenkins.jenkins_job_id=:jenkinsJobId";
	...
	public static String GET_PARTICULAR_USERS_DETAILS="SELECT um.user_id, um.name, upm.projectMaster.project_name, upm.roleMaster.role_name " +
			"from UserMaster um, UserProjectMapping upm " +
			"where um.user_id = upm.userMaster.user_id AND um.user_id=:user_id"; 
	...
	public static String GET_PARTICULAR_USER_FROM_UPM="from UserProjectMapping upm where upm.userMaster.user_id=:userId and upm.projectMaster.project_id=:project_id " +
			"and upm.accountMaster.account_id=:account_id and upm.portfolioMaster.portfolio_id=:portfolio_id"; 
	...
	public static String GET_ALL_UPMS="from UserProjectMapping upm where upm.userMaster.user_id=:userId";
 
	public static String GET_USERS_TO_DEALLOCATE="select distinct upm.id FROM UserProjectMapping upm" +
			" where upm.userMaster.user_id=:userId " +
			"AND upm.projectMaster.project_id=:projectId";
	
	public static String GET_USERS_FROM_UPM="select distinct upm.id FROM UserProjectMapping upm" +
			" where upm.userMaster.user_id=:userId " +
			"AND upm.projectMaster.project_id=:projectId" +
			"AND upm.roleMaster.role_id=:roleId";

	public static final String GET_DEFAULT_PROJECT_FOR_USER="SELECT upm.projectMaster.project_id FROM UserMaster usrmst, UserProjectMapping upm where upm.userMaster.user_id=:userId AND upm.default_project='Y'";
	...
	public static String GET_USERS_MAPPING_WITH_PROJECT_WITH_ROLE="from UserProjectMapping upm where upm.userMaster.user_id=:userId and upm.projectMaster.project_id=:projectId and upm.roleMaster.role_id=:roleId";
	...
	public static String GET_PARTICULAR_CATEGORY="from CategoryMaster where category_id=:categoryId"; 

	//public static String GET_ALL_TOOLS_IN_CATEGORY="select tm.tool_id, tm.tool_name,tm.nodeMaster.node_id,tm.command_to_execute,tm.report_path  from ToolMaster tm where tm.categoryMaster.category_id=:categoryId";

	public static String GET_ALL_TOOLS_IN_CATEGORY="from ToolMaster tm where tm.categoryMaster.category_id=:categoryId";
	...
	public static String GET_PARTICULAR_TOOL_FROM_TOOL_MAPPING="from ProjectToolMapping where tool_id=:toolId and project_id=:projectId";

		public static String GET_MAPPING="from ProjectToolMapping where tool_project_mapping_id=:projectToolMappingId";





	public static String GET_ALL_TOOLS_MAPPINGS="from ProjectToolMapping"; 

	//	public static String GET_TOOLS_FOR_PROJECT = "select ptm.tool_project_mapping_id, ptm.toolMastertool_id, tm.tool_name, ptm.command_to_execute,ptm.report_path,tm.tool_logo,tm.categoryMaster.category_id,tm.categoryMaster.category_name,tm.nodeMaster.node_id,tm.nodeMaster.node_name from ToolMaster tm, ProjectToolMapping ptm where "
	//		 		+ "tm.tool_id=ptm.toolMaster.tool_id "
	//		 		+ "and ptm.projectMaster.project_id=:projectId ";

	//	 public static String GET_TOOLS_FOR_PROJECT = "select ptm.tool_project_mapping_id, ptm.command_to_execute, ptm.report_path, ptm.toolMaster.tool_id, ptm.toolMaster.tool_name," +
	//	 		"tm.tool_logo, tm.categoryMaster.category_id,  tm.categoryMaster.category_name, " +
	//	 		"ptm.nodeMaster.node_name from ToolMaster tm, ProjectToolMapping ptm where tm.tool_id=ptm.toolMaster.tool_id and ptm.projectMaster.project_id=:projectId";
	//	

	public static String GET_TOOLS_FOR_PROJECT="select ptm.tool_project_mapping_id, ptm.command_to_execute,ptm.report_path, " +
			" ptm.toolMaster.tool_id, tm.tool_name,tm.tool_logo, tm.categoryMaster.category_id, cm.category_name, ptm.nodeMaster.node_name" +
			" from ToolMaster tm, ProjectToolMapping ptm, CategoryMaster cm where tm.tool_id=ptm.toolMaster.tool_id " +
			"and ptm.projectMaster.project_id=:projectId and cm.category_id=tm.categoryMaster.category_id";


	public static final String GET_ALL_SUBMODULES="FROM  ModuleSubJobsJenkins msj WHERE msj.moduleJobsJenkins.jenkins_job_id=:jobId";
	
	public static final String GET_TOOL_CATEGORY="SELECT tm.categoryMaster.category_id FROM  ToolMaster tm WHERE tm.tool_name=:tool_name";

	public static final String JENKINS_NAME ="from ModuleJobsJenkins mjj where mjj.jenkins_job_id=:jenkinsJobId";

	//query to get list of module names for project   
	public static final String GETALLSUBJOBS="SELECT msj.subjob_name FROM ModuleSubJobsJenkins msj";

	public static final String GET_MBH="SELECT mbh.module_build_history_id FROM ModuleBuildHistory mbh where mbh.moduleJobsJenkins.jenkins_job_id=:jenkins_job_id and mbh.build_number=:build_number";
	

	//************************************End of Queries By Sueanne***********************************************//
	...
	public static String GET_TOOLS_FOR_PORTFOLIO = "select tm.tool_id,tm.tool_name,tm.command_to_execute,tm.report_path," +
			"tm.tool_logo,tm.categoryMaster.category_id,tm.categoryMaster.category_name," +
			"tm.nodeMaster.node_id,tm.nodeMaster.node_name from ToolMaster tm, ProjectToolMapping ptm where "
			+ "tm.tool_id=ptm.toolMaster.tool_id "
			+ "and ptm.projectMaster.project_id=:projectId ";
	
	public static final String GET_ALL_PROJECT_IDS = "select project_id from ProjectMaster"; 
	
	
	
	//jyoti
	public static final String GET_MODULE_BY_NAME="from  ModuleJobsJenkins as mjb where mjb.jenkins_job_name=:moduleName";
	public static final String GET_PARAMETERS_BY_MODULE_ID = "from ModuleJonsJenkinsParameters param where param.ModuleJobsJenkins.jenkins_job_id=:moduleId";
