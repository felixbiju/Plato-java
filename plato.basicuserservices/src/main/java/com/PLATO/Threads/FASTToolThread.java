...
/*  Description : Thread to call the service that reads jenkins console for FAST job.
 *  Author : Gaurav Kulkarni
 * 
 * */
public class FASTToolThread implements Callable<String>
{
	private String threadName;
	private String toolName;
	private int nextBuildNumber;
	private int buildHistoryId;
	private static final Logger logger=Logger.getLogger(FASTToolThread.class);
	public FASTToolThread(String toolName,String jobName,int nextBuildNumber,int buildHistoryId)
	{
	...
	public String call()
	{
		...
		try
		{
			...
			String read_fast_console=GlobalConstants.JENKINS_CONSOLE_SERVICES_URL+":"+GlobalConstants.JENKINS_CONSOLE_SERVICES_PORT+"/PlatoBuildMongoDBService/PlatoMongoTemplate/fastReportService/"+buildHistoryId+"/"+encodedthreadName+"/"+nextBuildNumber+"/avc/"+toolName;
			System.out.println("read_fast_console "+read_fast_console);
			//String read_fast_console="http://localhost:8085/PlatoBuildMongoDBService/PlatoMongoTemplate/fastReportService/"+buildHistoryId+"/"+threadName+"/"+nextBuildNumber+"/avc";
