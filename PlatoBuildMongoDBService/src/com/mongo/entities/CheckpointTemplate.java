...
public class CheckpointTemplate {
	...
	@OneToMany(mappedBy="checkpoint_template", cascade=CascadeType.ALL)
	private Set<CheckpointDetailsTemplate> checkpoint_details_template;
	...
	public Set<CheckpointDetailsTemplate> getCheckpoint_details_template() {
		return checkpoint_details_template;
	}
	public void setCheckpoint_details_template(
			Set<CheckpointDetailsTemplate> checkpoint_details_template) {
