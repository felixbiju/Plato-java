...
public class SubjobCheckpoint {
	...
	@OneToMany(fetch = FetchType.EAGER, mappedBy="subjob_checkpoint", cascade=CascadeType.ALL, orphanRemoval=true)
	private List<SubjobCheckpointDetails> checkpoint_criteria;
	...
	public List<SubjobCheckpointDetails> getCheckpoint_criteria() {
		return checkpoint_criteria;
	}
	public void setCheckpoint_criteria(List<SubjobCheckpointDetails> checkpoint_criteria) {
